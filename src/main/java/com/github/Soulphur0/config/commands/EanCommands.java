...
public class EanCommands {
    ...
    public static void register() {
        CommandRegistrationCallback.EVENT.register(
                (dispatcher, registryAccess, environment) -> dispatcher.register(literal(MOD_ID)
                        // < HELP INFO
                        .executes(context -> {
                            ServerPlayerEntity player = context.getSource().getPlayer();
                            Text message = Text.literal("\n")
                                    .append(Text.literal(
                                                    "Type '/ean' and press TAB to see available options.\nWrite '-help' at the end of each option to see its usage and default values.\n\n")
                                            .formatted(Formatting.GOLD))
                                    .append(Text.literal("You can read an in-depth guide about this command ")
                                            .append(Text.literal("clicking here.\n")
                                                    .formatted(Formatting.UNDERLINE)
                                                    .styled((style -> style.withClickEvent(
                                                            new ClickEvent(ClickEvent.Action.OPEN_URL,
                                                                    "https://github.com/Soulphur0/Soulphur-Mods-ResoucesAndChangelogs/blob/main/ElytraAeronautics/mod_resources/ean_command_guide.md"))))));
                        ...
                        .then(argument("configMode", string()).suggests((commandContext, suggestionsBuilder) -> {
                                ...
                                .then(argument("arg1", string()).suggests((commandContext, suggestionsBuilder) -> {
                                        ...
                                        .then(argument("arg2", string()).suggests(
                                                        (commandContext, suggestionsBuilder) -> {
                                                            String configMode = StringArgumentType.getString(commandContext,
                                                                    "configMode");
                                                            String arg1 = StringArgumentType.getString(commandContext, "arg1");
                                                            Collection<String> suggestions = new ArrayList<>();

                                                            // ? Suggestions for CloudConfig
                                                            if (configMode.equals("CloudConfig") && arg1.equals(
                                                                    "configCloudLayer")) {
                                                                suggestions.add("all");
                                                                try {
                                                            ...
                                                            } else if (configMode.equals("CloudConfig") && arg1.equals(
                                                                    "loadPreset")) {
                                                            ...
                                                            if (configMode.equals("FlightConfig") && arg1.equals(
                                                                    "altitudeDeterminesSpeed")) {
                                                                suggestions.add("-help");
                                                                suggestions.add("true");
                                                                suggestions.add("false");
                                                            } else if (configMode.equals("FlightConfig") && arg1.equals(
                                                                    "minSpeed")) {
                                                                suggestions.add("-help");
                                                ...
                                                .executes(context -> {
                                                    ...
                                                    String configMode = StringArgumentType.getString(context,
                                                            "configMode");
                                                    String arg1 = StringArgumentType.getString(context, "arg1");
                                                    String value = StringArgumentType.getString(context, "arg2");
                                                    String message = "";

                                                    if (configMode.equals("FlightConfig") && (context.getSource()
                                                            .hasPermissionLevel(4) || context.getSource()
                                                            .getServer()
                                                            .isSingleplayer())) {
                                                        message = switch (arg1) {
                                                            case "altitudeDeterminesSpeed" ->
                                                                    setAltitudeDeterminesSpeed(value);
                                                            ...
                                                            case "sneakingRealignsPitch" ->
                                                                    setSneakingRealignsPitch(value);
                                                            case "realignAngle" -> setRealignAngle(value);
                                                            case "realignRate" -> setRealignRate(value);
                                                            default -> throw new SimpleCommandExceptionType(
                                                                    Text.translatable("command.error.value")).create();
                                                        };
                                                    } else if (configMode.equals("FlightConfig") && !context.getSource()
                                                            .hasPermissionLevel(4)) {
                                                        context.getSource()
                                                                .sendMessage(Text.literal(
                                                                                "You require to be an operator in order to change elytra flight settings.")
                                                                        .formatted(Formatting.RED));
                                                    } else if (configMode.equals("CloudConfig")) {
                                                        switch (arg1) {
                                                            case "useEanCloudRendering" ->
                                                                    setUseEanCloudRendering(executor, value);
                                                            case "setCloudLayerAmount" ->
                                                                    setCloudLayerAmount(executor, value);
                                                ...
                                                .then(argument("arg3", string())
                                                        ...
                                                        .suggests((commandContext, suggestionsBuilder) -> {
                                                            String configMode = StringArgumentType.getString(
                                                                    commandContext, "configMode");
                                                            Collection<String> suggestions = new ArrayList<>();
                                                        ...
                                                        .then(argument("value", string()).suggests(
                                                                        (commandContext, suggestionsBuilder) -> {
                                                                            String configMode = StringArgumentType.getString(
                                                                                    commandContext, "configMode");
                                                                            Collection<String> suggestions = new ArrayList<>();
                                                                            ...
                                                                            if (configMode.equals("CloudConfig")) {
                                                                                String layerAttribute = StringArgumentType.getString(
                                                                                        commandContext, "arg3");

                                                                                if (Objects.equals(layerAttribute,
                                                                                        "altitude")) {
                                                                                    suggestions.add("-help");
                                                                                    suggestions.add("192");
                                                                                } else if (Objects.equals(layerAttribute,
                                                                                        "cloudType")) {
                                                                                    suggestions.add("-help");
                                                                                    suggestions.add("LOD");
                                                                ...
                                                                .executes(context -> {
                                                                    ServerPlayerEntity executor = context.getSource()
                                                                            .getPlayer();
                                                                    String configMode = StringArgumentType.getString(
                                                                            context, "configMode");

                                                                    if (configMode.equals("CloudConfig")) {
                                                                        String layerNumber = StringArgumentType.getString(
                                                                                context, "arg2");
                                                                        String layerAttribute = StringArgumentType.getString(
                                                                                context, "arg3");
                                                                        ...
                                                                        switch (layerAttribute) {
                                                                            case "altitude" ->
                                                                                    setLayerAltitude(executor,
                                                                                            layerNumber, value);
                                                                            case "cloudType" ->
                                                                                    setLayerCloudType(executor,
                                                                                            layerNumber, value);
                                                                            case "verticalRenderDistance" ->
                                                                                    setLayerVerticalRenderDistance(
                                                                                            executor, layerNumber,
                                                                                            value);
                                                                            case "horizontalRenderDistance" ->
                                                                                    setLayerHorizontalRenderDistance(
                                                                                            executor, layerNumber,
                                                                                            value);
                                                                            case "lodRenderDistance" ->
                                                                                    setLodRenderDistance(executor,
                                                                                            layerNumber, value);
                                                                            case "thickness" ->
                                                                                    setLayerCloudThickness(executor,
                                                                                            layerNumber, value);
                                                                            case "color" ->
                                                                                    setCloudColor(executor, layerNumber,
                                                                                            value);
                                                                            case "opacity" -> setCloudOpacity(executor,
                                                                                    layerNumber, value);
                                                                            case "shading" ->
                                                                                    setShading(executor, layerNumber,
                                                                                            value);
                                                                            case "speed" ->
                                                                                    setCloudSpeed(executor, layerNumber,
                                                                                            value);
                                                                            case "skyEffects" ->
                                                                                    setSkyEffects(executor, layerNumber,
                                                                                            value);
                                                                            default ->
                                                                                    throw new SimpleCommandExceptionType(
                                                                                            Text.translatable(
                                                                                                    "command.error.attribute")).create();
                                                                        }
                                                                    }
                                                                    return 1;
                                                                }))))))));
    ...
    private static String setAltitudeDeterminesSpeed(String value) throws CommandSyntaxException {
        if (Objects.equals(value, "-help")) return """
    ...
    private static void setUseEanCloudRendering(ServerPlayerEntity executor, String value) {
        ...
        EanServerPacketSender.sendClientConfig(executor,
                new EanClientSettings("generalCloudConfig", "useEanCloudRendering", value));
    }

    private static void setCloudLayerAmount(ServerPlayerEntity executor, String value) {
        // Send config change to the command executor's client.
        EanServerPacketSender.sendClientConfig(executor,
                new EanClientSettings("generalCloudConfig", "setCloudLayerAmount", value));
    }

    private static void loadPreset(ServerPlayerEntity executor, String value) {
        // Send config change to the command executor's client.
        EanServerPacketSender.sendClientConfig(executor,
                new EanClientSettings("generalCloudConfig", "loadPreset", value));
    }
    ...
    private static void setLayerAltitude(ServerPlayerEntity executor, String layerNumberArg, String value) {
        // Send config change to the command executor's client.
        EanServerPacketSender.sendClientConfig(executor,
                new EanClientSettings("cloudLayerConfig", "altitude", layerNumberArg, value));
    }

    private static void setLayerCloudType(ServerPlayerEntity executor, String layerNumberArg, String value) {
        // Send config change to the command executor's client.
        EanServerPacketSender.sendClientConfig(executor,
                new EanClientSettings("cloudLayerConfig", "cloudType", layerNumberArg, value));
    }

    private static void setLayerVerticalRenderDistance(ServerPlayerEntity executor, String layerNumberArg,
                                                       String value) {
        // Send config change to the command executor's client.
        EanServerPacketSender.sendClientConfig(executor,
                new EanClientSettings("cloudLayerConfig", "verticalRenderDistance", layerNumberArg, value));
    }

    private static void setLayerHorizontalRenderDistance(ServerPlayerEntity executor, String layerNumberArg,
                                                         String value) {
        // Send config change to the command executor's client.
        EanServerPacketSender.sendClientConfig(executor,
                new EanClientSettings("cloudLayerConfig", "horizontalRenderDistance", layerNumberArg, value));
    }

    private static void setLodRenderDistance(ServerPlayerEntity executor, String layerNumberArg, String value) {
        // Send config change to the command executor's client.
        EanServerPacketSender.sendClientConfig(executor,
                new EanClientSettings("cloudLayerConfig", "lodRenderDistance", layerNumberArg, value));
    }

    private static void setLayerCloudThickness(ServerPlayerEntity executor, String layerNumberArg, String value) {
        // Send config change to the command executor's client.
        EanServerPacketSender.sendClientConfig(executor,
                new EanClientSettings("cloudLayerConfig", "thickness", layerNumberArg, value));
    }

    private static void setCloudColor(ServerPlayerEntity executor, String layerNumberArg, String value) {
        // Send config change to the command executor's client.
        EanServerPacketSender.sendClientConfig(executor,
                new EanClientSettings("cloudLayerConfig", "color", layerNumberArg, value));
    }

    private static void setCloudOpacity(ServerPlayerEntity executor, String layerNumberArg, String value) {
        // Send config change to the command executor's client.
        EanServerPacketSender.sendClientConfig(executor,
                new EanClientSettings("cloudLayerConfig", "opacity", layerNumberArg, value));
    }

    private static void setShading(ServerPlayerEntity executor, String layerNumberArg, String value) {
        // Send config change to the command executor's client.
        EanServerPacketSender.sendClientConfig(executor,
                new EanClientSettings("cloudLayerConfig", "shading", layerNumberArg, value));
    }

    private static void setCloudSpeed(ServerPlayerEntity executor, String layerNumberArg, String value) {
        // Send config change to the command executor's client.
        EanServerPacketSender.sendClientConfig(executor,
                new EanClientSettings("cloudLayerConfig", "speed", layerNumberArg, value));
    }

    private static void setSkyEffects(ServerPlayerEntity executor, String layerNumberArg, String value) {
        // Send config change to the command executor's client.
        EanServerPacketSender.sendClientConfig(executor,
                new EanClientSettings("cloudLayerConfig", "skyEffects", layerNumberArg, value));
    }
}